...
- All 20 modules are authored (346 questions total): M06 pilot in v2.11.0, the other 19 filled in by a verified agent fleet in v2.11.1. The curriculum still reports "not authored yet" for any declared module without a bank, which is the state a future milestone re-enters by adding a module before its bank; a bank with no declared module is an integrity failure
